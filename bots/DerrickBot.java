 ...
 */
public class DerrickBot extends Bot {
	 ...
	 */
	private String[] killMessages = { "Woohoo!!!", "In your face!", "LOL", "Take that.", "Gotcha!", "Too easy.",
	...
	public String[] imageNames() {
		String[] paths = { "monster_up.png", "monster_down.png", "monster_right.png", "monster_left.png" };
		return paths;
	}
